...
var getSeriesOrdinal = function getSeriesOrdinal(qualifiers) {
...
var parseWikidataName = function parseWikidataName(_ref, lang) {
  var value = _ref.value,
      qualifiers = _ref.qualifiers;
  var statedAs = getStatedAs(qualifiers);
  var name = statedAs || fetchWikidataLabel(value, lang)[0];
  name = (0, _name.default)(name);
...
var parseWikidataProp = function parseWikidataProp(name, value, lang) {
  ...
  var cslValue = function (prop, valueList) {
    ...
    switch (prop) {
      ...
      case 'P110':
      case 'P655':
        return valueList.map(function (name) {
          return parseWikidataName(name, lang);
        });
...
var parseWikidataNameAsync = function () {
  var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(_ref4, lang) {
    var value, qualifiers, statedAs, name;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            value = _ref4.value, qualifiers = _ref4.qualifiers;
            statedAs = getStatedAs(qualifiers);
            _context2.t0 = statedAs;
...
var parseWikidataPropAsync = function () {
  var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(prop, value, lang) {
    var cslValue;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return function () {
              var _ref7 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(prop, valueList) {
                var value;
                return regeneratorRuntime.wrap(function _callee3$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 4:
                        return _context3.abrupt("return", Promise.all(valueList.map(function (name) {
                          return parseWikidataNameAsync(name, lang);
                        })));
